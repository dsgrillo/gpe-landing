    ...
    >
      ...
      <div className="lg:w-6/12 xs:w-10/12 m-auto bg-white bg-opacity-10 rounded-2xl p-6">
        ...
        <div className="mt-8">
          ...
          <textarea className="w-full h-32 bg-gray-50 text-gray-700 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"></textarea>
        </div>
        <div className="mt-8">
          <Button className={"uppercase"}>Enviar mensagem</Button>
        </div>
      </div>
    </section>
  );

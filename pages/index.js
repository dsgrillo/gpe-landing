      ...
      <section className="bg-white border-b py-8">
        <div className="container max-w-5xl mx-auto m-8">
          ...
          <Link href={"/docs/01-introduction"}>
            <a className="w-full block text-center bg-blue-900 text-white mx-auto lg:mx-0 hover:underline font-bold rounded-full mt-4 lg:mt-0 py-4 px-8 shadow opacity-75 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
              Saiba mais
            </a>
          </Link>
        </div>
